...
urlpatterns = [
    ...
    path("prestations_en_attentes/", prestations_en_attentes, name="prestations_en_attentes"),
    path("prestations/add/", add_prestation, name="add_prestations"),
    path("prestations/confirmer_prestation/", confirmer_prestation, name="confirmer_prestation"),
    path("prestations/details/<str:id_prestation>", get_prestation_details, name="get_prestation_details"),
